...
# 读取数据集
print('user_info')
user_info_train = pd.read_csv('../data/train/user_info_train_3_2.csv')
user_info_test = pd.read_csv('../data/test/user_info_test_3_2.csv')
# 合并train、test
...
user_info.to_csv('../data/part3_2/data1.csv' , index = False , encoding="utf-8" , mode='a')
...
user_info.to_csv('../data/part3_2/data2.csv' , index = False , encoding="utf-8" , mode='a')
...
user_info.to_csv('../data/part3_2/data3.csv' , index = False , encoding="utf-8" , mode='a')
...
user_info.to_csv('../data/part3_2/data4.csv' , index = False , encoding="utf-8" , mode='a')
...
user_info.to_csv('../data/part3_2/train.csv' , index = False , encoding="utf-8" , mode='a') # data6.csv是这一部分用户的训练集（在这个程序里面一块做出来）
